...
public class ApplicationDetails extends AppCompatActivity {
    ...
    private String residenceID, applicantID, numOfUnit, monthlyRental, username, monthlyIncome, requiredMonth,requiredYear ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        applyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ApplicationDetails.this, MakeApplication.class);
